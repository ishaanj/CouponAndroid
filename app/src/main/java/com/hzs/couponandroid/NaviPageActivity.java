...
public class NaviPageActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    public static final String TAG = "NaviPageActivity";
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new EarnPointsFragment(), "Earn Points");
        adapter.addFragment(new VaultFragment(), "Vault");
    ...
    private void setupTabIcons() {
        try {
            ...
            tabLayout.getTabAt(2).setIcon(R.drawable.ic_lock_black_24dp);
        }
        catch (NullPointerException npe) {
            Log.e(TAG, "Null tab layout");
        }
    }
